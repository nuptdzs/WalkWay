...
public class BaseDialog extends DialogFragment {
    ...
    private int backResourceId = R.drawable.ui_base_dialog_bg;
    ...
    public void setDialogBackgroudResource(int drawable){
        this.backResourceId = drawable;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (rootView == null){
            ...
            if (backResourceId != -1){
                rootView.setBackgroundResource(backResourceId);
            }
