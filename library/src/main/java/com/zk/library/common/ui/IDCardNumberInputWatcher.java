...
/**
 * Created by TOM on 14-2-26.
 */
public class IDCardNumberInputWatcher implements TextWatcher {
    ...
    public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        if (!mFormatting) {
            ...
            if (s.length() > 1 // Can delete another character
                    ...
                    && after == 0 // Deleting
                    && s.charAt(start) == ' ' // a hyphen //注意这里是格式判断如果修改修改这里
    ...
    public  void formatNanpNumber(Editable text) {
        ...
        if (length > "nnnnnn nnnnnnnn nnnn".length()) {
            //这里是判断格式长度的
...
//                    }
                ...
                case '0':
                    ...
                    } else if (state != NANP_STATE_DASH && (numDigits == 6 || numDigits == 14)) {
