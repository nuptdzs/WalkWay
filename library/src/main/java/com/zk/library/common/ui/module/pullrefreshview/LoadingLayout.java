...
public class LoadingLayout extends FrameLayout {
	...
	public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel,
		...
		switch(type){
		case 0:
			header = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.ui_pull_to_refresh_header, this);
			break;
		case 1:
			header = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.ui_pull_to_load_footer, this);
			break;
		}
