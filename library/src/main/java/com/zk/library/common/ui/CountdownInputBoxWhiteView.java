...
//    private TextView inputVerifyCodeLable;
     ...
     * @param attrs
     */
    public CountdownInputBoxWhiteView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    }
    ...
    private void initView(){
        LayoutInflater.from(context).inflate(R.layout.ui_cutdown_eidt_white,this);
...
//    }
    ...
    class TimeCount extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished){//计时过程显示
            ...
            getVerfyCodeButton.setTextColor(Color.parseColor("#328566"));
        }
    }
