...
public class TwoLineTextView extends IconItemView {
    ...
    public void setFirstLineTextMarginBottom(int margin){
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) firstLineText.getLayoutParams();
    ...
    protected void init(AttributeSet attrs){
        ...
        margin = ta.getDimension(R.styleable.TwoLineTextView_firstLineTextMarginBottom,dp10);
