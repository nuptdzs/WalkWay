...
public class CommonAdapter<MODEL> extends BaseAdapter {
     ...
     */
    private BaseViewHolder<MODEL> instance;
    /**
     * list布局所需要承载的数据源
     */
     ...
     * @param t 模型视图源
     */
    public CommonAdapter(List<MODEL> models, BaseViewHolder<MODEL> t){
        instance = t;
        modelList = models;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            t = (BaseViewHolder<MODEL>) view.getTag();//直接获取view 即缓存好的 mvpview
        }
