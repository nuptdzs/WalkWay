...
public class NavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    private TextView closeButton;      //关闭按钮
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.nav_close && closeButton.isShown()) {
...
//        }
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            statusBarBackgroud  = typedArray.getResourceId(R.styleable.NavigationBar_statusBarBg, getResources().getColor(R.color.color_black_3b4255));
    ...
    private void initView() {
        ...
        //关闭按钮
        closeButton.setText(actionText);
        closeButton.setTextColor(textColor);
        closeButton.setBackgroundResource(closeBg);
        ...
        if (Float.compare(btnTextSize, 0.0f) > 0) {
            ...
            closeButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, btnTextSize);
        }
